...
/**
 * @return the bactTimeMin
 */
public LocalTime getBactTimeMin() {
	return BactTimeMin;
}
/**
 * @param bactTimeMin the bactTimeMin to set
 */
public void setBactTimeMin(LocalTime bactTimeMin) {
	BactTimeMin = bactTimeMin;
}
/**
...
/**
 * @return the bactTimeMax
 */
public LocalTime getBactTimeMax() {
	return BactTimeMax;
}
/**
 * @param bactTimeMax the bactTimeMax to set
 */
public void setBactTimeMax(LocalTime bactTimeMax) {
	BactTimeMax = bactTimeMax;
}
/**
...
public FlightCriteria(CompanyName company, FlightType flightType, TravelType travelType, String departureLocation,
		...
		LocalDate backDateMin, LocalTime departureTimeMin, LocalTime arrivalTimeMin, LocalTime bactTimeMin,
		LocalDate departureDateMax, LocalDate arrivalDateMax, LocalDate backDateMax, LocalTime departureTimeMax,
		LocalTime arrivalTimeMax, LocalTime bactTimeMax, LocalTime connectionDurationMin,
